...
signupBtn.addEventListener("click", async function () {
  ...
  if (emailValue === "") {
    showError(signupEmailInput, signupEmailError, "Please enter your email address.");
    hasError = true;
  ...
  if (passwordValue === "") {
    showError(signupPasswordInput, signupPasswordError, "Please enter your password.");
    signupPasswordRules.classList.add("hidden");
    hasError = true;
  ...
  if (fnameValue === "") {
    showError(signupFnameInput, signupFnameError, "Please enter your first name.");
    hasError = true;
  }

  if (lnameValue === "") {
    showError(signupLnameInput, signupLnameError, "Please enter your last name.");
    hasError = true;
  }

  if (dobValue === "") {
    showError(signupDobInput, signupDobError, "Please enter your date of birth.");
    hasError = true;
  }

  if (phoneValue === "") {
    showError(signupPhoneInput, signupPhoneError, "Please enter your phone number.");
    hasError = true;
  }
